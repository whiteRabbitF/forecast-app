        ...
        <div class="highlight">
            ...
            <div class="card-info">
                ...
                <div class="info-main">
                    ...
                    <div class="info-main-text"> м/с
                    </div>
                </div> 
                <div class="info-main">
                    <div class="info-main-num">{{  weatherInfo?.wind?.deg }} </div>
                    <div class="info-main-text">гр.</div>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="card-small-info">
                ...
                <div class="card-small-text text-egorova">
                    Узнать больше о порывах
                    <a href="https://www.windy.com/articles/weather-phenomena-what-s-the-difference-between-sustained-winds-and-wind-gusts-10390?satellite,7.787,115.115,5" target="_blank">здесь</a>
                </div>
                </div>
            </div>
            </div>
...
<script setup>
import { getPressureMm, getTime } from '../utils/unit'
...
.highlights
  ...
  background: url('/src/assets/img/gradient-3.jpg') no-repeat 0% 0%
